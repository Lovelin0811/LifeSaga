...
class CompleteSagaCommandTest {
    ...
    void shouldCreateCommandWithRequiredFields() {
        ...
        CompleteSagaCommand command = new CompleteSagaCommand(sagaId, sagaOwnerId);
    ...
    void shouldRejectNullSagaId() {
        IllegalArgumentException exception = assertThrows(
                ...
                () -> new CompleteSagaCommand(null, new SagaOwnerId(1))
        );
    ...
    void shouldRejectNullSagaOwnerId() {
        IllegalArgumentException exception = assertThrows(
                IllegalArgumentException.class,
                () -> new CompleteSagaCommand(new SagaId(1), null)
        );
