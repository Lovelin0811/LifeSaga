...
| 2 | 在 `back/` 下创建本地配置文件 `application-local.yml` |
...
| `back/application-prod.example.yml` | 生产配置模板，适合 YAML 方式部署 |
| `back/local.properties.example` | 生产配置模板，适合服务器 `local.properties` 方式部署 |
